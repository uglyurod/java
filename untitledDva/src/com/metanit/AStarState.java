...
public class AStarState {
    ...
    private HashMap<Location, Waypoint>
            openWaypoints;
    ...
    public Waypoint getMinOpenWaypoint() {
        if (openWaypoints.isEmpty()) /** isEmpty() возвращает логическое
     ...
     * доабвляем новую вершину только в том случае, если стоимость пути до
