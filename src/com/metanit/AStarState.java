...
public class AStarState {
    ...
    private final HashMap<Location, Waypoint>
            openWaypoints;
    ...
    public Waypoint getMinOpenWaypoint() {
        if (openWaypoints.isEmpty()) /** isEmpty() возвращает
         значение Boolean которое указывает была ли инициализирована переменная.**/
            return null;
        else {
    ...
    /**
     * Добавляет в указанную вершину только в том случае если существующая
     * вершина хуже новой.
     * Если в наборе открытых вершин в настоящее время нет вершины для
     * данного местоположения
     * то просто добавляем.
     * Если в наборе открытых вершин уже есть вершина для этой локации
     * добавляем новую вершину только в том случае если стоимость пути до
     * новой вершины меньше стоимости пути до текущей.
     **/
    public boolean addOpenWaypoint(Waypoint newWP) {
        Location loc;
        loc = newWP.getLocation();
    ...
    /**
     * Возвращает значение true, если указанное местоположение встречается в наборе закрытых вершин,
     * и false в противном
     **/
